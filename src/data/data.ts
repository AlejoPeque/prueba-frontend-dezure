export const transcriptionData = [
  ...
  {
    content:
      "El precio de la Licenciatura en Desarrollo de Software es de 36 mensualidades de dos mil ochocientos pesos mexicanos. ¿Te gustaría saber más sobre los beneficios?",
    role: "agent",
    start: 52.838,
    end: 61.523,
  },
